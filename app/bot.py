...
from app.handlers.custom_info import register_handlers as register_custom_info_handlers  # CUSTOM-UI
from app.handlers.custom_stub import register_handlers as register_custom_stub_handlers  # CUSTOM-UI
